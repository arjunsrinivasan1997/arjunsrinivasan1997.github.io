...
function startGUI() {
  ...
  gui.add(config, "DENSITY_DISSIPATION", 0.9, 1.0).name("density");
  gui.add(config, "VELOCITY_DISSIPATION", 0.9, 1.0).name("velocity");
...
function render(target) {
  ...
  if (config.SHADING) {
    ...
    gl.uniform2f(
      displayShadingProgram.uniforms.texelSize,
      1.0 / width,
      1.0 / height
    );
